...
return ( <section
 ...
 >
{/* Background Glow */} <div className="absolute top-20 right-20 w-72 h-72 bg-blue-500/10 rounded-full blur-[60px]" /> <div className="absolute bottom-20 left-20 w-72 h-72 bg-cyan-500/10 rounded-full blur-[60px]" />
